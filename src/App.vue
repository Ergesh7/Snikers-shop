...
<template>
  <div class="bg-white rounded-[20px]">
    <header
      class="flex justify-between items-center py-[43px] border-b-gray-200 border-b px-[45px]"
    >
      <img src="./assets/1st-logo.png" alt="" />
      <nav class="flex gap-[32px] item-center">
        <div @click="" class="flex gap-[10px]">
          <img src="./assets/cart-logo.svg" alt="" />
          <span>1205 руб.</span>
        </div>
        <RouterLink class="flex gap-[10px]" to="/favorite">
          <img src="./assets/heart-logo.svg" alt="" />
          <span>Закладки</span>
        </RouterLink>
      </nav>
    </header>
